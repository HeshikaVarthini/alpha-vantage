...
from config import all_companies, sector_mapping, FINANCIAL_SENTIMENT_LEXICON
...
if "alpha_vantage_api_key_input" not in st.session_state:
    st.session_state.alpha_vantage_api_key_input = os.environ.get("ALPHA_VANTAGE_API_KEY", "")
...
alpha_vantage_api_key = st.sidebar.text_input(
    ...
    type="password",
    key="alpha_vantage_api_key_input",
)
